...
![ezgif com-gif-maker (4)](https://user-images.githubusercontent.com/93863133/143807354-b1bfda02-c0e1-4062-84ba-62eb1cbea250.gif)


### 사용 방법

- 지정된 좌표로 텔레포트하면, 컨테이너가 실행되며 웹사이트를 띄울 수 있게 됩니다.
- 'o' 키를 누르면 현재 브라우저에서 해당 웹사이트가 실행됩니다.
- 다시 밖으로 나가면 컨테이너가 종료되며 웹사이트가 종료됩니다.
...
- 텔레포트할 수 있는 좌표를 사용자가 임의로 설정하도록 구현
- AI챗봇, 또다른 게임 등을 적용하여 몹과의 전투양상 다양화
- 사용자가 직접 입력한 웹사이트 실행 / 블록 설치 가능하도록 변경
- NPC와 음성대화 적용 / 사용자 간 상호작용 강화(음성/영상대화)
